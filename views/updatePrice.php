    ...
    <div class="row mt-5">
      <div class="col-2">
        <div class="list-group">
          ...
          >
          <a href="./updatePrice.php" class="list-group-item list-group-item-action  active" aria-current="true"
          ...
          <div class="col-md-10 content-center card">
            <div class="card-body">
              <div class="card-title">
                <h3 class="text-center mt-3 mb-5">Update Subscription Price</h3>
              </div>
              <form method="POST" action="../controllers/priceData.php">
                <div class="row">
                  <div class="col-4">
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Daily Price </label>
                      <input
                        type="text"
                        class="form-control"
                  ...
                  <div class="col-4">
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Weekly Price </label>
                      <input
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
